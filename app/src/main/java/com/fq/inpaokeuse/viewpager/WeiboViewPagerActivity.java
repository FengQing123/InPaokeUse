...
public class WeiboViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        tv1.setTextColor(ContextCompat.getColor(WeiboViewPagerActivity.this, R.color.black));
        tv1.setTextSize(20);
        tv2.setTextColor(ContextCompat.getColor(WeiboViewPagerActivity.this, R.color.gray));
        tv2.setTextSize(17);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 0) {
                    ...
                    tv2.setTextColor(ContextCompat.getColor(WeiboViewPagerActivity.this, R.color.black));
                    tv2.setTextSize(20);
                    tv1.setTextColor(ContextCompat.getColor(WeiboViewPagerActivity.this, R.color.gray));
                    tv1.setTextSize(17);
                }
            }
