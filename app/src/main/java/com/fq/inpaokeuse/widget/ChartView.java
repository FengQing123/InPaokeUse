...
//                    canvas.drawRoundRect(x - xValueRect.width() / 2 - dpToPx(3), mYOri + xyLineWidth + dpToPx(1),
//                            x + xValueRect.width() / 2 + dpToPx(3), mYOri + xyLineWidth + dpToPx(2) + xValueRect.height() + dpToPx(2),
//                            dpToPx(2), dpToPx(2), mXYTextPaint);
                    RectF rectF = new RectF(x - xValueRect.width() / 2 - dpToPx(3), mYOri + xyLineWidth + dpToPx(1),
                            x + xValueRect.width() / 2 + dpToPx(3), mYOri + xyLineWidth + dpToPx(2) + xValueRect.height() + dpToPx(2));
                    canvas.drawRoundRect(rectF, dpToPx(2), dpToPx(2), mXYTextPaint);
                } else {
                    canvas.drawText(text, 0, text.length(), x - rect.width() / 2, mYOri + xyLineWidth + dpToPx(2) + rect.height(), mXYTextPaint);
                }
            }
