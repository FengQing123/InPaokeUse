package com.fq.inpaokeuse.widget.dropmenu;
...
public class DropPopMenu {
    ...
    private boolean isShowListDivider = false;
    private int listDividerDrawable;
    ...
    private void create() {
        mPopupWindow = new PopupWindow(mDropPopLayout, LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    ...
    private void initListView() {
        ...
        if (isShowListDivider) {
            mListView.setDivider(mContext.getResources().getDrawable(listDividerDrawable));
    ...
    public void setIsShowListDivider(boolean flag, int drawable) {
        isShowListDivider = flag;
        listDividerDrawable = drawable;
    }
